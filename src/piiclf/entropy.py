...
def looks_random(value: str) -> bool:
    """Entropy test with charset-aware thresholds.

    Hex uses a 16-symbol alphabet so its ceiling is 4.0 bits/char; base64-ish
    strings reach ~6.0. A single threshold would either miss random hex or flag
...
def has_low_variety(value: str) -> bool:
    """Reject padding and repeated-character runs: 'aaaaaaaa', 'xxxxxxxxxxxx', '000000'."""
    if not value:
        return True
